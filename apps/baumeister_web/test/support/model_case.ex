defmodule BaumeisterWeb.Web.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import BaumeisterWeb.Web.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&BaumeisterWeb.Web.ErrorHelpers.translate_error/1)
